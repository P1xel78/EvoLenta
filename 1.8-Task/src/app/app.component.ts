  ...
  Report(type: string) {
    switch (type) {
      case '1':
        Report.success(
          'Отлично',
          '"Вы успешно посмотрели на реализацию отчета с помощью Notiflix." <br/><br/>- Сообщение от сайта',
          'Okay'
        );
        break;
      case '2':
        Report.failure(
          'Ошибка',
          '"Вы плохо посмотрели на реализацию отчета с помощью Notiflix." <br/><br/>- Сообщение от сайта',
          'Okay'
        );
        break;
    }
